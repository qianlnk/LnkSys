...
uses
  ...
  forms,
  MyPub,
  uXtdmMain in 'uXtdmMain.pas' {frmXtdmMain},
  uXtdmSub in 'uXtdmSub.pas' {frmXtdmSub};

{$R *.res}
const
  MODUALEID = 'xtdmbylnk00000000000';   //模块号，修改成相应的模块号
 var
...
begin
  ...
  frmDll := TfrmXtdmMain.Create(Application);
  with frmDll do
  begin
