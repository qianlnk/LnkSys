...
var
  frmGcjdDel: TfrmGcjdDel;

implementation

{$R *.dfm}

procedure TfrmGcjdDel.btnCancleClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfrmGcjdDel.btnSureClick(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TfrmGcjdDel.chkDelClick(Sender: TObject);
begin
...
procedure TfrmGcjdDel.chkExpiredClick(Sender: TObject);
begin
...
procedure TfrmGcjdDel.FormCreate(Sender: TObject);
begin
