...
var
  frmCsgcDel: TfrmCsgcDel;

implementation

{$R *.dfm}

procedure TfrmCsgcDel.btnCancleClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfrmCsgcDel.btnSureClick(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TfrmCsgcDel.chkDelClick(Sender: TObject);
begin
...
procedure TfrmCsgcDel.chkExpiredClick(Sender: TObject);
begin
...
procedure TfrmCsgcDel.FormCreate(Sender: TObject);
begin
