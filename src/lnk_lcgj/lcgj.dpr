...
uses
  ...
  forms,
  MyPub,
  uLcgjMain in 'uLcgjMain.pas' {frmLcgjMain},
  uLcgjSub in 'uLcgjSub.pas' {frmLcgjSub},
  uLcgjDel in 'uLcgjDel.pas' {frmLcgjDel};

{$R *.res}
const
  MODUALEID = 'lcgjbylnk00000000000';   //模块号，修改成相应的模块号
 var
...
begin
  ...
  frmLcgj := TfrmLcgjMain.Create(Application);
  with frmLcgj do
  begin
