...
var
  frmDllDel: TfrmDllDel;

implementation

{$R *.dfm}

procedure TfrmDllDel.btnCancleClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfrmDllDel.btnSureClick(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TfrmDllDel.chkDelClick(Sender: TObject);
begin
...
procedure TfrmDllDel.chkExpiredClick(Sender: TObject);
begin
...
procedure TfrmDllDel.FormCreate(Sender: TObject);
begin
