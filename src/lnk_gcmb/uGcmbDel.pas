...
var
  frmGcmbDel: TfrmGcmbDel;

implementation

{$R *.dfm}

procedure TfrmGcmbDel.btnCancleClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfrmGcmbDel.btnSureClick(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TfrmGcmbDel.chkDelClick(Sender: TObject);
begin
...
procedure TfrmGcmbDel.chkExpiredClick(Sender: TObject);
begin
...
procedure TfrmGcmbDel.FormCreate(Sender: TObject);
begin
