...
uses
  ...
  forms,
  MyPub,
  uCsgcMain in 'uCsgcMain.pas' {frmCsgcMain},
  uCsgcSub in 'uCsgcSub.pas' {frmCsgcSub},
  uCsgcDel in 'uCsgcDel.pas' {frmCsgcDel};

{$R *.res}
const
  MODUALEID = 'csgcbylnk00000000000';   //模块号，修改成相应的模块号
 var
...
begin
  ...
  frmCsgc := TfrmCsgcMain.Create(Application);
  with frmCsgc do
  begin
